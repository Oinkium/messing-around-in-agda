...
du54 v0
  = coe MAlonzo.Code.Data.Product.C30
      ...
      (\ v1 v2 v3 v4 ->
         coe d40 v0 v3 v2 v1
           (coe MAlonzo.Code.Function.du158 (coe d38 v0 v3 v2)
              (coe MAlonzo.Code.Relation.Binary.Core.d518 (coe d36 v0) v2 v3
                 v4)))
name70 = "Relation.Binary.Preorder"
d70 a0 a1 a2 = ()

data T70 a0 a1 a2 a3 = C67 a0 a1 a2 a3
...
data T120 a0 a1 a2 = C85 a0 a1 a2
...
du150 v0 = coe C67 erased erased erased (coe du148 v0)
...
data T200 a0 a1 a2 = C189 a0 a1 a2
...
d232 v0 = coe C85 erased erased (coe d182 (coe d216 v0))
name236 = "Relation.Binary.DecSetoid._.preorder"
d236 v0 v1 v2 = du236 v2
du236 v0
  = coe du150 (coe C85 erased erased (coe d182 (coe d216 v0)))
name250 = "Relation.Binary.IsPartialOrder"
d250 a0 a1 a2 a3 a4 a5 = ()

data T250 a0 a1 = C217 a0 a1
...
d276 v0 v1
  = coe d38 (coe d268 v0) v1 v1
      (coe MAlonzo.Code.Relation.Binary.Core.d516 (coe d36 (coe d268 v0))
         v1)
...
data T300 a0 a1 a2 a3 = C235 a0 a1 a2 a3
...
d332 v0 v1
  = coe d38 (coe d268 (coe d322 v0)) v1 v1
      (coe MAlonzo.Code.Relation.Binary.Core.d516
...
du338 v0 = coe du282 (coe d322 v0)
...
du344 v0 = coe du288 (coe d322 v0)
...
d398 v0 v1
  = coe d38 (coe d268 (coe d384 v0)) v1 v1
      (coe MAlonzo.Code.Relation.Binary.Core.d516
...
du404 v0 = coe du282 (coe d384 v0)
name418 = "Relation.Binary.IsDecPartialOrder.Eq.isDecEquivalence"
d418 v0 = coe C175 (coe d36 (coe d268 (coe d384 v0))) (coe d386 v0)
...
du428 v0
  = coe du190
      (coe C175 (coe d36 (coe d268 (coe d384 v0))) (coe d386 v0))
...
data T440 a0 a1 a2 a3 = C289 a0 a1 a2 a3
...
d478 v0 v1
  = coe d38 (coe d268 (coe d384 (coe d462 v0))) v1 v1
      (coe MAlonzo.Code.Relation.Binary.Core.d516
...
du484 v0 = coe du404 (coe d462 v0)
name490 = "Relation.Binary.DecPoset.DPO.Eq.isDecEquivalence"
d490 v0
  = coe C175 (coe d36 (coe d268 (coe d384 (coe d462 v0))))
      (coe d386 (coe d462 v0))
name502 = "Relation.Binary.DecPoset.poset"
d502 v0 = coe C235 erased erased erased (coe d384 (coe d462 v0))
name506 = "Relation.Binary.DecPoset._.preorder"
d506 v0
  = coe C67 erased erased erased (coe d268 (coe d384 (coe d462 v0)))
name510 = "Relation.Binary.DecPoset.Eq.decSetoid"
d510 v0
  = coe C189 erased erased
      (coe C175 (coe d36 (coe d268 (coe d384 (coe d462 v0))))
         (coe d386 (coe d462 v0)))
...
data T548 a0 a1 a2 a3 = C327 a0 a1 a2 a3
name570 = "Relation.Binary.IsStrictPartialOrder.isEquivalence"
d570 v0
  = case coe v0 of
        C327 v1 v2 v3 v4 -> coe v1
        _ -> coe MAlonzo.RTE.mazUnreachableError
...
data T594 a0 a1 a2 a3 = C349 a0 a1 a2 a3
...
d704 v0 = coe C175 (coe d570 (coe d676 v0)) (coe d678 v0)
...
data T726 a0 a1 a2 a3 = C433 a0 a1 a2 a3
...
d770 v0
  = coe C175 (coe d570 (coe d676 (coe d748 v0)))
      (coe d678 (coe d748 v0))
name782
  = "Relation.Binary.DecStrictPartialOrder.strictPartialOrder"
d782 v0 = coe C349 erased erased erased (coe d676 (coe d748 v0))
...
d806 v0 = coe C85 erased erased (coe d570 (coe d676 (coe d748 v0)))
...
d854 v0 v1
  = coe d38 (coe d268 (coe d842 v0)) v1 v1
      (coe MAlonzo.Code.Relation.Binary.Core.d516
...
du860 v0 = coe du282 (coe d842 v0)
...
du866 v0 = coe du288 (coe d842 v0)
...
data T878 a0 a1 a2 a3 = C477 a0 a1 a2 a3
...
d912 v0 v1
  = coe d38 (coe d268 (coe d842 (coe d900 v0))) v1 v1
      (coe MAlonzo.Code.Relation.Binary.Core.d516
...
du920 v0 = coe du860 (coe d900 v0)
...
du926 v0 = coe du866 (coe d900 v0)
...
d986 v0 v1
  = coe d38 (coe d268 (coe d842 (coe d970 v0))) v1 v1
      (coe MAlonzo.Code.Relation.Binary.Core.d516
...
du994 v0 = coe du860 (coe d970 v0)
name1008 = "Relation.Binary.IsDecTotalOrder.Eq.isDecEquivalence"
d1008 v0
  = coe C175 (coe d36 (coe d268 (coe d842 (coe d970 v0))))
      (coe d972 v0)
...
data T1030 a0 a1 a2 a3 = C531 a0 a1 a2 a3
...
d1070 v0 v1
  = coe d38 (coe d268 (coe d842 (coe d970 (coe d1052 v0)))) v1 v1
      (coe MAlonzo.Code.Relation.Binary.Core.d516
...
du1078 v0 = coe du994 (coe d1052 v0)
...
d1096 v0 = coe C477 erased erased erased (coe d970 (coe d1052 v0))
name1100 = "Relation.Binary.DecTotalOrder._.poset"
d1100 v0
  = coe C235 erased erased erased
      (coe d842 (coe d970 (coe d1052 v0)))
name1102 = "Relation.Binary.DecTotalOrder._.preorder"
d1102 v0
  = coe C67 erased erased erased
      (coe d268 (coe d842 (coe d970 (coe d1052 v0))))
name1106 = "Relation.Binary.DecTotalOrder.Eq.decSetoid"
d1106 v0
  = coe C189 erased erased
      (coe C175 (coe d36 (coe d268 (coe d842 (coe d970 (coe d1052 v0)))))
         (coe d972 (coe d1052 v0)))
...
du1174 v0 = coe C175 (coe d1164 v0) (coe du1170 v0)
...
d1190 v0 v1 v2 v3 v4 v5 v6 = du1190 v2 v5 v6
du1190 v0 v1 v2
  = coe MAlonzo.Code.Relation.Binary.Consequences.du410 v0 v1
      (coe d1168 v2)
name1192
  = "Relation.Binary.IsStrictTotalOrder.isStrictPartialOrder"
d1192 v0 v1 v2 v3 v4 v5 v6 = du1192 v2 v5 v6
du1192 v0 v1 v2
  = coe C327 (coe d1164 v2) erased (coe d1166 v2)
      (coe du1190 v0 v1 v2)
...
data T1204 a0 a1 a2 a3 = C683 a0 a1 a2 a3
...
du1234 v0 v1 = coe du1190 v0 erased (coe d1226 v1)
...
du1244 v0 v1 = coe du1192 v0 erased (coe d1226 v1)
...
du1248 v0 v1 = coe C349 erased erased erased (coe du1244 v0 v1)
name1250 = "Relation.Binary.StrictTotalOrder.decSetoid"
d1250 v0 v1 v2 v3 = du1250 v3
du1250 v0 = coe C189 erased erased (coe du1240 v0)
...
du1264 v0 = coe du236 (coe du1250 v0)
...
du1268 v0 = coe du226 (coe du1250 v0)
name1270 = "Relation.Binary.StrictTotalOrder.Eq.setoid"
d1270 v0 v1 v2 v3 = du1270 v3
du1270 v0
  = coe C85 erased erased (coe d182 (coe d216 (coe du1250 v0)))
