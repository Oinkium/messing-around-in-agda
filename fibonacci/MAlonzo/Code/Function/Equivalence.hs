...
d56 v0 v1 v2 v3 v4 v5 = du56 v2 v3 v4 v5
du56 v0 v1 v2 v3
  = coe C1
      (coe MAlonzo.Code.Relation.Binary.PropositionalEquality.du210
         (coe MAlonzo.Code.Relation.Binary.C85 v1 erased
...
d140 v0 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14 v15 v16 v17
  v18 v19 v20 v21 = du140 v18 v19 v20 v21
du140 v0 v1 v2 v3
  = coe C1 (coe v0 (coe d34 v2) (coe d34 v3))
      (coe v1 (coe d36 v2) (coe d36 v3))
name158 = "Function.Equivalence.id"
d158 v0 v1 v2 = du158
du158
  = coe C1 MAlonzo.Code.Function.Equality.du62
...
du210
  = coe MAlonzo.Code.Relation.Binary.C85 erased erased
      (coe MAlonzo.Code.Relation.Binary.Core.C605
         (coe d158 erased erased)
         (coe d192 erased erased erased erased)
         (\ v0 v1 v2 ->
            coe MAlonzo.Code.Function.d138 erased erased erased erased erased
              erased
              (coe d174 erased erased erased erased erased erased erased erased
                 erased)))
name218 = "Function.Equivalence.\8660-setoid"
d218 v0 = du218
du218
  = coe MAlonzo.Code.Relation.Binary.C85 () erased
      (coe MAlonzo.Code.Relation.Binary.Core.C605 (\ v0 -> du158)
         (\ v0 v1 -> coe d192 erased erased erased erased erased erased)
         (\ v0 v1 v2 ->
            coe MAlonzo.Code.Function.d138 erased erased erased erased erased
              erased
              (coe d174 erased erased erased erased erased erased erased erased
