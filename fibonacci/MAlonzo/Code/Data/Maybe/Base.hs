...
type AgdaMaybe a b = Maybe b {- OMG hack :: -}
...
du34
  = coe MAlonzo.Code.Function.d38 erased erased erased erased erased
      erased
      (\ v0 -> MAlonzo.Code.Data.Bool.Base.d6)
      (coe d28 erased erased)
name40 = "Data.Maybe.Base.decToMaybe"
d40 v0 v1 v2 = du40 v2
du40 v0
  = case coe v0 of
        MAlonzo.Code.Relation.Nullary.C22 v1 -> coe Just v1
        MAlonzo.Code.Relation.Nullary.C26 v1 -> coe Nothing
        _ -> coe MAlonzo.RTE.mazUnreachableError
...
du76 = coe d56 erased erased erased erased
...
du106 v0
  = coe d56 erased erased erased erased
      (coe MAlonzo.Code.Function.d38 erased erased erased erased erased
         erased
         (\ v1 -> coe Just)
         v0)
