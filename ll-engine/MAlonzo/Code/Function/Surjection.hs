...
d82 v0
  = coe MAlonzo.Code.Function.LeftInverse.C163 (coe d38 (coe d74 v0))
      (coe d72 v0)
      (coe d40 (coe d74 v0))
...
du86 v0 v1 v2
  = coe MAlonzo.Code.Function.LeftInverse.d188 erased erased erased
      ...
      v1
      v0
      (coe MAlonzo.Code.Function.LeftInverse.C163 (coe d38 (coe d74 v2))
         (coe d72 v2)
         (coe d40 (coe d74 v2)))
name88 = "Function.Surjection.Surjection.injective"
d88 v0 v1 v2 v3 v4 v5 v6 = du88 v5 v6
du88 v0 v1
  = coe MAlonzo.Code.Function.LeftInverse.d172 erased erased erased
      erased
      v0
      erased
      (coe MAlonzo.Code.Function.LeftInverse.C163 (coe d38 (coe d74 v1))
         (coe d72 v1)
         (coe d40 (coe d74 v1)))
...
d92 v0
  = coe MAlonzo.Code.Function.Equivalence.C1 (coe d72 v0)
      (coe d38 (coe d74 v0))
name106 = "Function.Surjection.fromRightInverse"
d106 v0 v1 v2 v3 v4 v5 v6 = du106 v6
du106 v0
  = coe C101 (coe MAlonzo.Code.Function.LeftInverse.d104 v0)
      (coe C55 (coe MAlonzo.Code.Function.LeftInverse.d102 v0)
...
du146 v0
  = coe C101 MAlonzo.Code.Function.Equality.du62
      (coe C55
         (coe MAlonzo.Code.Function.LeftInverse.d102 (coe du154 v0))
