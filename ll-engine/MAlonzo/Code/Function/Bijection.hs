...
du48 v0 v1 v2
  = coe d38 v1
      ...
      v2
      (coe MAlonzo.Code.Function.Surjection.d40 (coe d40 v1)
         (coe MAlonzo.Code.Function.Equality.d38 v0 v2))
name64 = "Function.Bijection.Bijection"
d64 a0 a1 a2 a3 a4 a5 = ()

data T64 a0 a1 = C175 a0 a1
...
du92 v0
  = coe d48 erased erased erased erased erased erased (coe d82 v0)
      (coe d84 v0)
...
d98 v0
  = coe MAlonzo.Code.Function.Injection.C59 (coe d82 v0)
      (coe d38 (coe d84 v0))
name100 = "Function.Bijection.Bijection.surjection"
d100 v0
  = coe MAlonzo.Code.Function.Surjection.C101 (coe d82 v0)
      (coe d40 (coe d84 v0))
name104 = "Function.Bijection.Bijection._.equivalence"
d104 v0
  = coe MAlonzo.Code.Function.Equivalence.C1 (coe d82 v0)
      (coe MAlonzo.Code.Function.Surjection.d38 (coe d40 (coe d84 v0)))
name106 = "Function.Bijection.Bijection._.to-from"
d106 v0 v1 v2 v3 v4 v5 v6 = du106 v4 v5 v6
du106 v0 v1 v2
  = coe MAlonzo.Code.Function.Surjection.du86 v0 v1
      (coe MAlonzo.Code.Function.Surjection.C101 (coe d82 v2)
         (coe d40 (coe d84 v2)))
...
du110 v0
  = coe MAlonzo.Code.Function.LeftInverse.C163 (coe d82 v0)
      (coe MAlonzo.Code.Function.Surjection.d38 (coe d40 (coe d84 v0)))
      (coe du92 v0)
name114 = "Function.Bijection.Bijection._.to-from"
d114 v0 v1 v2 v3 v4 v5 v6 = du114 v4 v5 v6
du114 v0 v1 v2
  = coe MAlonzo.Code.Function.LeftInverse.d188 erased erased erased
      erased
      v0
      v1
      (coe du110 v2)
...
du122 v0
  = coe C175 MAlonzo.Code.Function.Equality.du62
      (coe C73
         (coe MAlonzo.Code.Function.Injection.d108
            MAlonzo.Code.Function.Injection.du126)
         (coe MAlonzo.Code.Function.Surjection.d74
...
du144 v0 v1 v2
  = coe C175
      ...
      (coe C73
         (coe MAlonzo.Code.Function.Injection.d108
            (coe MAlonzo.Code.Function.Injection.du146
               (coe MAlonzo.Code.Function.Injection.C59 (coe d82 v1)
                  (coe d38 (coe d84 v1)))
               (coe MAlonzo.Code.Function.Injection.C59 (coe d82 v2)
                  (coe d38 (coe d84 v2)))))
         (coe MAlonzo.Code.Function.Surjection.d74
            (coe MAlonzo.Code.Function.Surjection.du174 v0
               (coe MAlonzo.Code.Function.Surjection.C101 (coe d82 v1)
                  (coe d40 (coe d84 v1)))
               (coe MAlonzo.Code.Function.Surjection.C101 (coe d82 v2)
                  (coe d40 (coe d84 v2))))))