...
d90 v0
  = coe MAlonzo.Code.Function.LeftInverse.C163 (coe d78 v0)
      (coe d80 v0)
      (coe d42 (coe d82 v0))
name94 = "Function.Inverse.Inverse._.injection"
d94 v0 v1 v2 v3 v4 v5 v6 = du94 v4 v6
du94 v0 v1
  = coe MAlonzo.Code.Function.LeftInverse.du180 v0
      (coe MAlonzo.Code.Function.LeftInverse.C163 (coe d78 v1)
         (coe d80 v1)
         (coe d42 (coe d82 v1)))
name96 = "Function.Inverse.Inverse._.injective"
d96 v0 v1 v2 v3 v4 v5 v6 = du96 v4 v6
du96 v0 v1
  = coe MAlonzo.Code.Function.LeftInverse.d172 erased erased erased
      erased
      v0
      erased
      (coe MAlonzo.Code.Function.LeftInverse.C163 (coe d78 v1)
...
du98 v0 v1
  = coe MAlonzo.Code.Function.Bijection.C175 (coe d78 v1)
      (coe MAlonzo.Code.Function.Bijection.C73 (coe du96 v0 v1)
         (coe MAlonzo.Code.Function.Surjection.C55 (coe d80 v1)
            (coe d44 (coe d82 v1))))
...
du102 v0 v1
  = coe MAlonzo.Code.Function.Equivalence.C1
      ...
      (coe MAlonzo.Code.Function.Surjection.d38
         (coe MAlonzo.Code.Function.Bijection.d40
...
du104 v0 v1 v2
  = coe MAlonzo.Code.Function.Bijection.du106 v0 v1 (coe du98 v0 v2)
...
du108 v0 v1
  = coe MAlonzo.Code.Function.Surjection.C101
      (coe MAlonzo.Code.Function.Bijection.d82 (coe du98 v0 v1))
      (coe MAlonzo.Code.Function.Bijection.d40
         (coe MAlonzo.Code.Function.Bijection.d84 (coe du98 v0 v1)))
...
du112 v0 v1 v2
  = coe MAlonzo.Code.Function.Bijection.du114 v0 v1 (coe du98 v0 v2)
...
du152 v0
  = coe C173 (coe MAlonzo.Code.Function.Bijection.d82 v0)
      (coe MAlonzo.Code.Function.Surjection.d38
         (coe MAlonzo.Code.Function.Bijection.d40
            (coe MAlonzo.Code.Function.Bijection.d84 v0)))
      (coe C109 (coe MAlonzo.Code.Function.Bijection.du92 v0)
         (coe MAlonzo.Code.Function.Surjection.d40
            (coe MAlonzo.Code.Function.Bijection.d40
               (coe MAlonzo.Code.Function.Bijection.d84 v0))))
...
du188 v0 v1 v2 v3
  = coe C173 (coe v0 (coe d78 v3)) (coe v1 (coe d80 v3))
...
d282 v0 v1 v2 v3 v4 v5 v6 v7 v8 v9 v10 v11 v12 v13 v14 v15 v16 v17
  v18 v19 v20 v21 v22 = du282 v18 v19 v20 v21 v22
du282 v0 v1 v2 v3 v4
  = coe C173 (coe v0 (coe d78 v3) (coe d78 v4))
      (coe v1 (coe d80 v3) (coe d80 v4))
      (coe v2 (coe d78 v3) (coe d80 v3) (coe d78 v4) (coe d80 v4)
         (coe d82 v3)
         (coe d82 v4))
name302 = "Function.Inverse.id"
d302 v0 v1 v2 = du302 v2
du302 v0
  = coe C173 MAlonzo.Code.Function.Equality.du62
...
du324 v0 v1 v2 v3 v4
  = coe C173
      ...
      (coe C109
         (coe MAlonzo.Code.Function.LeftInverse.d106
            (coe MAlonzo.Code.Function.LeftInverse.du254 v0
               (coe MAlonzo.Code.Function.LeftInverse.C163 (coe d78 v3)
                  (coe d80 v3)
                  (coe d42 (coe d82 v3)))
               (coe MAlonzo.Code.Function.LeftInverse.C163 (coe d78 v4)
                  (coe d80 v4)
                  (coe d42 (coe d82 v4)))))
         (coe MAlonzo.Code.Function.LeftInverse.d106
            (coe MAlonzo.Code.Function.LeftInverse.du254 v2 (coe du106 v0 v4)
               (coe du106 v1 v3))))
name342 = "Function.Inverse.sym"
d342 v0 v1 v2 v3 v4 v5 v6 = du342 v6
du342 v0
  = coe C173 (coe d80 v0) (coe d78 v0)
