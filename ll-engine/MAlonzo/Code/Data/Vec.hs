...
data T8 a0 a1 a2 = C14
                 | C22 a0 a1 a2
name28 = "Data.Vec._\8712_"
d28 a0 a1 a2 a3 a4 = ()

data T28 a0 a1 a2 a3 a4 = C42 a0 a1 a2
                        | C54 a0 a1 a2 a3 a4
name60 = "Data.Vec._[_]=_"
d60 a0 a1 a2 a3 a4 a5 = ()

data T60 a0 a1 a2 a3 a4 a5 = C74 a0 a1 a2
...
du118 v0 = coe C22 (0 :: Integer) v0 (coe C14)
name130 = "Data.Vec._++_"
d130 v0 v1 v2 v3 v4 v5 = du130 v2 v4 v5
du130 v0 v1 v2
  = case coe v1 of
        C14 -> coe v2
        C22 v3 v4 v5 -> coe C22
                          (coe ((Prelude.+) :: Integer -> Integer -> Integer) v0 v3)
                          v4
                          (coe du130 v0 v5 v2)
        _ -> coe MAlonzo.RTE.mazUnreachableError
  ...
  = case coe v0 of
        ...
        _ -> let v2
                   = coe ((Prelude.-) :: Integer -> Integer -> Integer) v0
                       (1 :: Integer)
               in coe C22 v2 v1 (coe du166 v2 v1)
name180 = "Data.Vec.applicative"
d180 v0 v1 = du180 v1
du180 v0
  = coe MAlonzo.Code.Category.Applicative.Indexed.C9
      (\ v1 -> coe d166 erased v0)
      (\ v1 v2 v3 -> coe d150 erased erased erased)
...
du230 v0
  = coe d212 erased erased erased v0 erased erased erased
      (coe MAlonzo.Code.Data.Product.C30)
name242 = "Data.Vec.unzip"
d242 v0 v1 v2 v3 v4 v5 = du242 v5
du242 v0
  = case coe v0 of
        C14 -> coe MAlonzo.Code.Data.Product.C30 (coe C14) (coe C14)
        C22 v1 v2 v3 -> coe MAlonzo.Code.Data.Product.du188
...
du286 v0 v1
  = case coe v1 of
        C22 v2 v3 v4 -> case coe v4 of
                            C14 -> coe v3
                            C22 v5 v6 v7 -> coe v0 v3 (coe du286 v0 (coe C22 v5 v6 v7))
                            _ -> coe MAlonzo.RTE.mazUnreachableError
        _ -> coe MAlonzo.RTE.mazUnreachableError
...
du354 v0 v1
  = case coe v1 of
        C14 -> coe C14
        C22 v2 v3 v4 -> coe du130
                          (coe ((Prelude.*) :: Integer -> Integer -> Integer) v2 v0)
                          v3
                          (coe du354 v0 v4)
        _ -> coe MAlonzo.RTE.mazUnreachableError
...
du374 v0 v1
  = case coe v0 of
        0 -> coe MAlonzo.Code.Data.Product.C30 (coe C14)
        ...
        _ -> let v2
               ...
               in
               case coe v1 of
                   C22 v3 v4 v5 -> let v6 = coe du374 v2 v5 in
                                     case coe v6 of
                                         MAlonzo.Code.Data.Product.C30 v7 v8 -> case coe v8 of
...
du404 v0 v1
  = let v2 = coe du374 v0 v1 in
      case coe v2 of
          MAlonzo.Code.Data.Product.C30 v3 v4 -> case coe v4 of
...
du456 v0 v1 v2
  = case coe v0 of
        0 -> coe seq v2
               (coe MAlonzo.Code.Data.Product.C30 (coe C14) erased)
        _ -> let v3
                   = coe ((Prelude.-) :: Integer -> Integer -> Integer) v0
                       (1 :: Integer)
               in
               let v4 = coe du374 v1 v2 in
                 case coe v4 of
                     MAlonzo.Code.Data.Product.C30 v5 v6 -> case coe v6 of
                                                                MAlonzo.Code.Data.Product.C30 v7
                                                                  v8 -> let v9 = coe du456 v3 v1 v7
                                                                          in
                                                                          case coe v9 of
                                                                              MAlonzo.Code.Data.Product.C30
                                                                                v10 v11 -> coe
...
du496 v0
  = case coe v0 of
        C14 -> coe MAlonzo.Code.Data.Product.C30 (coe C14) (coe C14)
        C22 v1 v2 v3 -> case coe v3 of
                            C14 -> coe MAlonzo.Code.Data.Product.C30
                                     (coe C22 (0 :: Integer) v2 (coe C14))
                                     (coe C14)
                            C22 v4 v5 v6 -> coe MAlonzo.Code.Data.Product.du188
                                              (coe C22 (coe MAlonzo.Code.Data.Nat.Base.d216 v4) v2)
                                              (\ v7 ->
                                                 coe C22 (coe MAlonzo.Code.Data.Nat.Base.d212 v4)
                                                   v5)
                                              (coe du496 v6)
                            _ -> coe MAlonzo.RTE.mazUnreachableError
        _ -> coe MAlonzo.RTE.mazUnreachableError
...
d512 v0 v1 v2 = du512
du512
  = coe d312 erased erased erased erased erased
      (\ v0 v1 v2 -> coe C22 v0 v2 v1)
      (coe C14)
name522 = "Data.Vec.sum"
d522 v0 = du522
du522
  = coe d262 erased erased erased erased erased
      (\ v0 -> ((Prelude.+) :: Integer -> Integer -> Integer))
      (0 :: Integer)
...
du542 v0
  = case coe v0 of
        [] -> coe C14
        (:) v1 v2 -> coe C22 (coe MAlonzo.Code.Data.List.Base.du226 v2) v1
                       (coe du542 v2)
        _ -> coe MAlonzo.RTE.mazUnreachableError
...
du576 v0 v1
  = case coe v0 of
        0 -> case coe v1 of
                 C22 v2 v3 v4 -> coe seq v4
                                   (coe MAlonzo.Code.Data.Product.C30 (coe C14)
        ...
        _ -> let v2
               ...
               in
               case coe v1 of
                   C22 v3 v4 v5 -> let v6 = coe du576 v2 v5 in
                                     case coe v6 of
                                         MAlonzo.Code.Data.Product.C30 v7 v8 -> case coe v8 of
                                                                                    MAlonzo.Code.Data.Product.C30
                                                                                      v9 v10 -> coe
...
name680 = "Data.Vec._\8910_"
d680 v0 v1 v2 v3 v4 v5 = du680 v2 v4 v5
du680 v0 v1 v2
  = case coe v1 of
        C14 -> coe v2
        C22 v3 v4 v5 -> coe C22 (coe MAlonzo.Code.Data.Nat.Base.d184 v0 v3)
                          v4
                          (coe du680 v3 v2 v5)
        _ -> coe MAlonzo.RTE.mazUnreachableError
name696 = "Data.Vec.lookup"
d696 v0 v1 v2 v3 v4 = du696 v3 v4
du696 v0 v1
  = case coe v0 of
        ...
        MAlonzo.Code.Data.Fin.C14 v2 v3 -> case coe v1 of
                                               C22 v4 v5 v6 -> coe du696 v3 v6
                                               _ -> coe MAlonzo.RTE.mazUnreachableError
        _ -> coe MAlonzo.RTE.mazUnreachableError
name714 = "Data.Vec.tabulate"
d714 v0 v1 v2 v3 = du714 v0 v3
du714 v0 v1
  = case coe v0 of
        0 -> coe C14
        _ -> let v2
                   = coe ((Prelude.-) :: Integer -> Integer -> Integer) v0
                       (1 :: Integer)
               in
               coe C22 v2 (coe v1 (coe MAlonzo.Code.Data.Fin.C8 v2))
                 (coe du714 v2
                    (coe MAlonzo.Code.Function.d38 erased erased erased erased erased
                       erased
                       (\ v3 -> v1)
                       (coe MAlonzo.Code.Data.Fin.C14 v2)))
name728 = "Data.Vec._[_]\8788_"
d728 v0 v1 v2 v3 v4 v5 = du728 v3 v4 v5
du728 v0 v1 v2
  = case coe v0 of
        C22 v3 v4 v5 -> case coe v1 of
                            MAlonzo.Code.Data.Fin.C8 v6 -> coe C22 v3 v2 v5
                            MAlonzo.Code.Data.Fin.C14 v6 v7 -> coe C22 v3 v4
                                                                 (coe du728 v5 v7 v2)
                            _ -> coe MAlonzo.RTE.mazUnreachableError
        _ -> coe MAlonzo.RTE.mazUnreachableError
name748 = "Data.Vec.allFin"
d748 v0
  = coe du714 v0 (coe MAlonzo.Code.Function.d68 erased erased)