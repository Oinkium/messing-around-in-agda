...
du18 v0
  = case coe v0 of
        C8 v1 -> 0 :: Integer
        C14 v1 v2 -> coe ((Prelude.+) :: Integer -> Integer -> Integer)
                       (1 :: Integer)
                       (coe du18 v2)
  ...
  = case coe v0 of
        ...
        _ -> let v1
                   = coe ((Prelude.-) :: Integer -> Integer -> Integer) v0
                       (1 :: Integer)
               in coe C14 v0 (coe d30 v1)
name38 = "Data.Fin.from\8469\8804"
d38 v0 v1 v2 = du38 v2
du38 v0
  = case coe v0 of
        MAlonzo.Code.Data.Nat.Base.C18 v1 v2 v3 -> case coe v3 of
                                                       MAlonzo.Code.Data.Nat.Base.C10 v4 -> coe C8
                                                                                              v2
                                                       MAlonzo.Code.Data.Nat.Base.C18 v4 v5
                                                         v6 -> coe C14
                                                                 (coe
...
du46 v0 v1
  = case coe v0 of
        0 -> case coe v1 of
                 MAlonzo.Code.Data.Nat.Base.C112 v2 v3 -> coe C8 v2
                 _ -> coe MAlonzo.RTE.mazUnreachableError
        _ -> let v2
                   = coe ((Prelude.-) :: Integer -> Integer -> Integer) v0
                       (1 :: Integer)
               in
               case coe v1 of
                   MAlonzo.Code.Data.Nat.Base.C112 v3 v4 -> coe C14
                                                              (coe
                                                                 ((Prelude.+) :: Integer -> Integer -> Integer)
                                                                 v0
                                                                 v3)
                                                              (coe du46 v2
                                                                 (coe
                                                                    MAlonzo.Code.Data.Nat.Base.C112
                                                                    v3
                                                                    erased))
                   _ -> coe MAlonzo.RTE.mazUnreachableError
name56 = "Data.Fin.#_"
...
du56 v0 v1
  = coe du38
      (coe MAlonzo.Code.Relation.Nullary.Decidable.du34
         (coe MAlonzo.Code.Data.Nat.Base.d254
  ...
  = case coe v1 of
        ...
        _ -> let v3
                   = coe ((Prelude.-) :: Integer -> Integer -> Integer) v1
                       (1 :: Integer)
               in
               coe C14 (coe ((Prelude.+) :: Integer -> Integer -> Integer) v3 v0)
                 (coe d64 v0 v3 v2)
...
du136 v0 v1
  = case coe v0 of
        C8 v2 -> case coe v1 of
                     MAlonzo.Code.Data.Nat.Base.C18 v3 v4 v5 -> coe C8 v4
                     _ -> coe MAlonzo.RTE.mazUnreachableError
        C14 v2 v3 -> case coe v1 of
                         MAlonzo.Code.Data.Nat.Base.C18 v4 v5 v6 -> coe C14 v5
                                                                      (coe du136 v3 v6)
                         _ -> coe MAlonzo.RTE.mazUnreachableError
        _ -> coe MAlonzo.RTE.mazUnreachableError
...
du148 v0
  = case coe v0 of
        ...
        C14 v1 v2 -> coe C14 (coe du18 (coe C14 v1 v2)) (coe du148 v2)
        _ -> coe MAlonzo.RTE.mazUnreachableError
...
du216 v0 v1 v2 v3
  = case coe v1 of
        ...
        _ -> let v4
               ...
               case coe v3 of
                   C8 v5 -> coe C8
                              (coe ((Prelude.+) :: Integer -> Integer -> Integer) v4 v0)
                   C14 v5 v6 -> coe C14
                                  (coe ((Prelude.+) :: Integer -> Integer -> Integer) v4 v0)
                                  (coe du216 v0 v4 v2 v6)
                   _ -> coe MAlonzo.RTE.mazUnreachableError
...
du240 v0 v1 v2
  = case coe v1 of
        C8 v3 -> coe v2
        C14 v3 v4 -> coe C14
                       (coe ((Prelude.+) :: Integer -> Integer -> Integer) (coe du18 v4)
                          v0)
                       (coe du240 v0 v4 v2)
        _ -> coe MAlonzo.RTE.mazUnreachableError
...
d292 = erased
name296 = "Data.Fin._<_"
d296 = erased
name298 = "Data.Fin._\8826_"
d298 a0 a1 = ()

data T298 a0 a1 = C304 a0 a1
name308 = "Data.Fin.Ordering"
d308 a0 a1 a2 = ()

data T308 a0 a1 = C316 a0 a1
                | C320 a0
                | C326 a0 a1
name334 = "Data.Fin.compare"
d334 v0 v1 v2 = du334 v1 v2
du334 v0 v1
  = case coe v0 of
        C8 v2 -> case coe v1 of
                     C8 v3 -> coe C320 (coe C8 v2)
                     C14 v3 v4 -> coe C316 (coe C14 v2 v4) (coe C8 (coe du18 v4))
                     _ -> coe MAlonzo.RTE.mazUnreachableError
        C14 v2 v3 -> case coe v1 of
                         C8 v4 -> coe C326 (coe C14 v2 v3) (coe C8 (coe du18 v3))
                         C14 v4 v5 -> let v6 = coe du334 v3 v5 in
                                        case coe v6 of
                                            C316 v7 v8 -> coe C316 (coe C14 v2 v7)
                                                            (coe C14 (coe du18 v7) v8)
                                            C320 v7 -> coe C320 (coe C14 v2 v7)
                                            C326 v7 v8 -> coe C326 (coe C14 v2 v7)
                                                            (coe C14 (coe du18 v7) v8)
                                            _ -> coe MAlonzo.RTE.mazUnreachableError
                         _ -> coe MAlonzo.RTE.mazUnreachableError
        _ -> coe MAlonzo.RTE.mazUnreachableError