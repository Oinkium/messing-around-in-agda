  ...
  = case coe v2 of
        ...
        _ -> let v3
                   = coe ((Prelude.-) :: Integer -> Integer -> Integer) v2
                       (1 :: Integer)
               in coe MAlonzo.Code.Agda.Primitive.d16 v0 (coe d6 v0 v1 v3)
...
du46 v0 v1
  = case coe v0 of
        0 -> coe v1 (coe MAlonzo.Code.Data.Vec.C14)
        _ -> let v2
...
du244 v0
  = coe MAlonzo.Code.Function.Equivalence.du56 erased ()
      (coe d264 erased erased erased erased erased v0 erased)
      (coe d282 erased erased erased erased erased v0 erased)
...
du304 v0
  = coe MAlonzo.Code.Function.Equivalence.du56 erased erased
      (coe d324 erased erased erased erased erased v0 erased)
      (coe d340 erased erased erased erased erased v0 erased)
  ...
  = case coe v0 of
        ...
        _ -> let v2
                   = coe ((Prelude.-) :: Integer -> Integer -> Integer) v0
                       (1 :: Integer)
               in
               coe MAlonzo.Code.Data.Product.du188
                 (coe MAlonzo.Code.Data.Vec.C22 v2
                    (coe MAlonzo.Code.Data.Product.d26 v1))
                 (\ v3 -> coe MAlonzo.Code.Function.d68 erased erased)
...
du340 v0 v1
  = case coe v0 of
        ...
        _ -> let v2
               ...
               in
               case coe v1 of
                   MAlonzo.Code.Data.Product.C30 v3 v4 -> case coe v3 of
                                                              MAlonzo.Code.Data.Vec.C22 v5 v6
                                                                v7 -> coe
...
du376 v0 v1
  = case coe v0 of
        ...
        _ -> let v2
               ...
               \ v3 ->
                 coe du376 v2
                   (\ v4 -> coe v1 (coe MAlonzo.Code.Data.Vec.C22 v2 v3 v4))
