...
du114
  = coe d92 erased erased erased erased erased erased
...
du120 v0 v1
  = case coe v1 of
        [] -> coe []
        (:) v2 v3 -> case coe v3 of
                         [] -> coe du10 v2
                         (:) v4 v5 -> coe (:) v2 (coe (:) v0 (coe du120 v0 (coe (:) v4 v5)))
                         _ -> coe MAlonzo.RTE.mazUnreachableError
        _ -> coe MAlonzo.RTE.mazUnreachableError
...
d184 v0 v1 = du184
du184
  = coe d144 erased erased erased erased (coe d18 erased erased)
      (coe [])
...
du194 v0
  = coe MAlonzo.Code.Function.d38 erased erased erased erased erased
      erased
      (\ v1 -> du184)
      (coe d56 erased erased erased erased v0)
name198 = "Data.List.Base.and"
d198
  = coe d144 erased erased erased erased
...
d234 v0 v1 = du234
du234
  = coe d166 erased erased erased erased (\ v0 v1 -> coe (:) v1 v0)
      (coe [])
...
du248 v0 v1 v2
  = case coe v2 of
        [] -> coe (:) v1 (coe [])
        (:) v3 v4 -> let v5 = coe du248 v0 v1 v4 in
                       case coe v5 of
                           [] -> coe []
                           (:) v6 v7 -> coe (:) (coe v0 v3 v6) (coe (:) v6 v7)
                           _ -> coe MAlonzo.RTE.mazUnreachableError
        _ -> coe MAlonzo.RTE.mazUnreachableError
  ...
  = case coe v1 of
        ...
        _ -> let v3
               ...
               let v4 = coe v0 v3 v2 in
                 case coe v4 of
                     Just v5 -> coe (:) (coe MAlonzo.Code.Data.Product.d26 v5)
                                  (coe du322 v0 v3 (coe MAlonzo.Code.Data.Product.d28 v5))
                     Nothing -> coe []
                     _ -> coe MAlonzo.RTE.mazUnreachableError
name362 = "Data.List.Base.downFrom"
d362 v0 = coe du322 (coe d378 erased) v0 (coe C374 v0)
...
du378 v0 v1
  = case coe v1 of
        C374 v2 -> coe Just
                     (coe MAlonzo.Code.Data.Product.C30 v0 (coe C374 v0))
        _ -> coe MAlonzo.RTE.mazUnreachableError
...
du426 v0 v1
  = case coe v0 of
        0 -> coe MAlonzo.Code.Data.Product.C30 (coe []) v1
        _ -> let v2
                   = coe ((Prelude.-) :: Integer -> Integer -> Integer) v0
                       (1 :: Integer)
               in
               case coe v1 of
                   [] -> coe MAlonzo.Code.Data.Product.C30 (coe []) (coe [])
                   (:) v3 v4 -> let v5 = coe du426 v2 v4 in
                                  coe MAlonzo.Code.Data.Product.C30
...
du516 v0 v1
  = case coe v1 of
        ...
        (:) v2 v3 -> let v4 = coe v0 v2 in
                       case coe v4 of
                           False -> coe MAlonzo.Code.Data.Product.C30 (coe []) (coe (:) v2 v3)
                           True -> coe MAlonzo.Code.Data.Product.du188 (coe (:) v2)
...
du546 v0
  = coe d516 erased erased
      (coe MAlonzo.Code.Function.d38 erased erased erased erased erased
         erased
         (\ v1 -> MAlonzo.Code.Data.Bool.Base.d6)
         v0)
...
du564 v0
  = case coe v0 of
        [] -> coe (:) (coe []) (coe [])
        (:) v1 v2 -> coe (:) (coe (:) v1 v2) (coe du564 v2)
        _ -> coe MAlonzo.RTE.mazUnreachableError
name574 = "Data.List.Base.InitLast"
d574 a0 a1 a2 = ()

data T574 a0 a1 = C580
                | C586 a0 a1
...
du594 v0
  = case coe v0 of
        [] -> coe C580
        (:) v1 v2 -> let v3 = coe du594 v2 in
                       case coe v3 of
                           C580 -> coe C586 (coe []) v1
...
du652 v0
  = coe d620 erased erased erased erased
      (\ v1 ->
         coe MAlonzo.Code.Data.Bool.Base.du14 (coe v0 v1) (coe Just v1)
           (coe Nothing))
