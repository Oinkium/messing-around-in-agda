...
data T20 a0 a1 a2 a3 a4 a5 = C34
                           | C48 a0 a1 a2 a3 a4 a5
...
du140 v0 v1 v2
  = case coe v2 of
        C34 -> coe v1
        C48 v3 v4 v5 v6 v7 v8 -> coe v0 v3 v5 v4 v6 v8 v7
                                   (coe du140 v0 v1 v8)
        _ -> coe MAlonzo.RTE.mazUnreachableError
...
du174 v0 v1
  = case coe v1 of
        C34 -> coe C34
        C48 v2 v3 v4 v5 v6 v7 -> coe C48 v2 v3 v4 v5 (coe v0 v2 v4 v6)
                                   (coe du174 v0 v7)
        _ -> coe MAlonzo.RTE.mazUnreachableError
...
du244 v0 v1
  = case coe v1 of
        C34 -> coe C34
        C48 v2 v3 v4 v5 v6 v7 -> coe C48 v4 v5 v2 v3 (coe v0 v2 v4 v6)
                                   (coe du244 v0 v7)
        _ -> coe MAlonzo.RTE.mazUnreachableError
...
du278 v0 v1 v2
  = case coe v1 of
        C34 -> coe seq v2 (coe C34)
        C48 v3 v4 v5 v6 v7 v8 -> case coe v2 of
                                     C48 v9 v10 v11 v12 v13 v14 -> coe C48 v3 v4 v11 v12
                                                                     (coe v0 v3 v5 v11 v7 v13)
                                                                     (coe du278 v0 v8 v14)
                                     _ -> coe MAlonzo.RTE.mazUnreachableError
        _ -> coe MAlonzo.RTE.mazUnreachableError
...
du304 v0 v1 v2
  = case coe v1 of
        C34 -> coe seq v2 (coe C34)
        C48 v3 v4 v5 v6 v7 v8 -> case coe v2 of
                                     C48 v9 v10 v11 v12 v13 v14 -> coe C48 v3 v4 v5 v6
                                                                     (coe v0 v3 v5 v7 v13)
                                                                     (coe du304 v0 v8 v14)
                                     _ -> coe MAlonzo.RTE.mazUnreachableError
        _ -> coe MAlonzo.RTE.mazUnreachableError
...
du330 v0
  = coe MAlonzo.Code.Data.Product.C30
      (coe d344 erased erased erased erased erased erased v0)
      (coe d356 erased erased erased erased erased erased v0)
...
du344 v0 v1 v2
  = case coe v1 of
        C34 -> coe seq v2 (coe C34)
        C48 v3 v4 v5 v6 v7 v8 -> case coe v2 of
                                     C48 v9 v10 v11 v12 v13 v14 -> coe C48 v9 v10 v5 v6
                                                                     (coe
...
du356 v0 v1 v2
  = case coe v1 of
        C34 -> coe seq v2 (coe C34)
        C48 v3 v4 v5 v6 v7 v8 -> case coe v2 of
                                     C48 v9 v10 v11 v12 v13 v14 -> coe C48 v5 v6 v11 v12
                                                                     (coe
...
du390 v0 v1 v2
  = case coe v1 of
        [] -> case coe v2 of
                  [] -> coe MAlonzo.Code.Relation.Nullary.C22 (coe C34)
                  (:) v3 v4 -> coe MAlonzo.Code.Relation.Nullary.C26 erased
                  _ -> coe MAlonzo.RTE.mazUnreachableError
        (:) v3 v4 -> case coe v2 of
                         [] -> coe MAlonzo.Code.Relation.Nullary.C26 erased
                         (:) v5 v6 -> let v7 = coe v0 v3 v5 in
                                        case coe v7 of
                                            MAlonzo.Code.Relation.Nullary.C22 v8 -> let v9
                                                                                          = coe
                                                                                              du390
                                                                                              v0
                                                                                              v4
                                            ...
                                            MAlonzo.Code.Relation.Nullary.C26 v8 -> coe
                                                                                      MAlonzo.Code.Relation.Nullary.C26
                                                                                      (coe
                                                                                         MAlonzo.Code.Function.d38
                                                                                         erased
...
du484 v0
  = coe MAlonzo.Code.Relation.Binary.Core.C605
      (coe d218 erased erased erased erased
         (coe MAlonzo.Code.Relation.Binary.Core.d516 v0))
      (coe d244 erased erased erased erased erased erased erased erased
         (coe MAlonzo.Code.Relation.Binary.Core.d518 v0))
      (coe d278 erased erased erased erased erased erased erased erased
         erased
         erased
         erased
         erased
...
du514 v0
  = coe MAlonzo.Code.Relation.Binary.C17
      ...
      (coe d200 erased erased erased erased erased erased erased erased
         (coe MAlonzo.Code.Relation.Binary.d38 v0))
      (coe d278 erased erased erased erased erased erased erased erased
         erased
         erased
         erased
         erased
         (coe MAlonzo.Code.Relation.Binary.d40 v0))
...
du552 v0
  = coe MAlonzo.Code.Relation.Binary.C175
      ...
      (coe d390 erased erased erased erased erased erased
         (coe MAlonzo.Code.Relation.Binary.d184 v0))
...
du586 v0
  = coe MAlonzo.Code.Relation.Binary.C217
      ...
      (coe d304 erased erased erased erased erased erased
         (coe MAlonzo.Code.Relation.Binary.d270 v0))
...
du680
  = coe MAlonzo.Code.Function.Inverse.C173
      ...
      (coe MAlonzo.Code.Function.Equality.C15
         (coe MAlonzo.Code.Function.d68 erased erased)
         (coe d674 erased erased))
      (coe MAlonzo.Code.Function.Inverse.C109
         (\ v0 ->
            coe du218 erased
              (coe MAlonzo.Code.Function.du68
                 (coe MAlonzo.Code.Function.du68 v0)))
         erased)
name690 = "Relation.Binary.List.Pointwise.decidable-\8801"
d690 v0 v1 v2 v3 v4 = du690 v1 v2 v3 v4
du690 v0 v1 v2 v3
  = coe MAlonzo.Code.Relation.Nullary.Decidable.du98 erased erased
      erased
      (coe d674 erased erased v2 erased)
      (coe du706 v0 v1 v2 v3)
name706 = "Relation.Binary.List.Pointwise._._._\8799_"
d706 v0 v1 v2 v3 v4 = du706 v1 v2
du706 v0 v1
  = coe MAlonzo.Code.Relation.Binary.d184
      (coe MAlonzo.Code.Relation.Binary.d216
         (coe du642
            (coe MAlonzo.Code.Relation.Binary.PropositionalEquality.du120 v0
               v1)))
name7571 = "Relation.Binary.List.Pointwise..absurdlambda"
d7571 = erased
name7805 = "Relation.Binary.List.Pointwise..absurdlambda"
d7805 = erased