...
d14 v0 v1 v2 v3 v4 v5 = du14 v1 v3
du14 v0 v1 = coe MAlonzo.Code.Data.Empty.d10 v0 v1 erased
...
d196 v0 v1 v2 v3 = du196 v0 v1 v2
du196 v0 v1 v2
  = case coe v2 of
...
du220
  = coe MAlonzo.Code.Category.Monad.Indexed.C1
      (\ v0 v1 -> coe d14 erased () erased erased)
      erased
...
d300 v0 v1 v2 v3 v4 v5 v6 v7 v8 = du300 v2 v5 v6 v7 v8
du300 v0 v1 v2 v3 v4
  = case coe v4 of
        MAlonzo.Code.Relation.Nullary.C22 v5 -> coe
                                                  ...
                                                  (coe MAlonzo.Code.Function.d68 erased erased)
                                                  (\ v6 ->
                                                     coe MAlonzo.Code.Function.d80 erased erased
                                                       erased
                                                       erased)
                                                  (coe v3 v5)
        MAlonzo.Code.Relation.Nullary.C26 v5 -> coe
                                                  ...
                                                  (coe MAlonzo.Code.Function.du58
                                                     (coe MAlonzo.Code.Data.Empty.d10 v0
                                                        (coe v1 v2))
                                                     v5)
        _ -> coe MAlonzo.RTE.mazUnreachableError
...
d328 v0 v1 v2 v3 v4 v5 v6 v7 = du328 v1 v4 v6 v7
du328 v0 v1 v2 v3
  = case coe v3 of
        MAlonzo.Code.Relation.Nullary.C22 v4 -> coe
                                                  ...
                                                  (coe MAlonzo.Code.Function.d80 erased erased
                                                     ...
                                                     erased)
                                                  (coe v2 v4)
        MAlonzo.Code.Relation.Nullary.C26 v4 -> coe Left
                                                  (coe MAlonzo.Code.Function.du58
                                                     (coe MAlonzo.Code.Data.Empty.d10 v0 v1)
                                                     v4)
        _ -> coe MAlonzo.RTE.mazUnreachableError
