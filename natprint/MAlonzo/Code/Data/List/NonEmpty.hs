...
du72 v0
  = case coe v0 of
        MAlonzo.Code.Data.Vec.C22 v1 v2 v3 -> coe C24 v2
...
du224 v0 v1
  = coe MAlonzo.Code.Data.List.Base.du144 (coe d38 erased erased) v1
      v0
name234 = "Data.List.NonEmpty.concat"
d234 v0 v1 v2 = du234 v2
du234 v0
  = coe du212 (coe d20 v0)
      (coe MAlonzo.Code.Data.List.Base.du184
         (coe MAlonzo.Code.Data.List.Base.du56
            (\ v1 -> coe (:) (coe d20 v1) (coe d22 v1))
            (coe d22 v0)))
...
d252 v0 v1 = du252
du252
  = coe d102 erased erased erased erased
      (\ v0 ->
         coe MAlonzo.Code.Function.du58
           (coe MAlonzo.Code.Data.Product.d134 erased erased erased erased v0)
...
du258 v0 v1
  = case coe v0 of
        [] -> coe du30 v1
        (:) v2 v3 -> coe C24 v2
                       (coe MAlonzo.Code.Data.List.Base.du32 v3 v1)
        _ -> coe MAlonzo.RTE.mazUnreachableError
...
du300 v0
  = let v1 = coe MAlonzo.Code.Data.List.Base.du594 (coe d22 v0) in
      let v2 = coe d20 v0 in
        case coe v1 of
            MAlonzo.Code.Data.List.Base.C580 -> coe C292 (coe []) v2
            MAlonzo.Code.Data.List.Base.C586 v3 v4 -> coe C292 (coe (:) v2 v3)
                                                        v4
            _ -> coe MAlonzo.RTE.mazUnreachableError
                         ...
                         case coe v4 of
                             False -> let v6
                                            = coe (:)
                                                (coe Right
                                                   (coe du30
                                                      (coe MAlonzo.Code.Data.Product.C30 v2
                                                         (coe MAlonzo.Code.Function.Equality.d38
                                                            (coe
                                                               MAlonzo.Code.Function.Equivalence.d36
                                                               (coe
                                                                  MAlonzo.Code.Data.Bool.Properties.d812
                                                                  (coe False)))
                                                            erased))))
                                                v5
                                        in
                                        case coe v5 of
                                            (:) v7 v8 -> case coe v7 of
                                                             Right v9 -> coe (:)
                                                                           (coe Right
                                                                              (coe du38
                                                                                 (coe
                                                     ...
                                                     (coe MAlonzo.Code.Data.Product.C30 v2
                                                        (coe MAlonzo.Code.Function.Equality.d38
                                                           (coe
                                                              MAlonzo.Code.Function.Equivalence.d36
                                                              (coe
                                                                 MAlonzo.Code.Data.Bool.Properties.d808
                                                                 (coe True)))
                                                           erased))))
                                               v5
                                       in
...
du486 v0
  = coe MAlonzo.Code.Function.d38 erased erased erased erased erased
      erased
      (\ v1 ->
         coe MAlonzo.Code.Data.List.Base.d620 erased erased erased erased
           (coe MAlonzo.Code.Data.Sum.d48 erased erased erased erased erased
              erased
              (coe MAlonzo.Code.Function.d80 erased erased erased erased
                 (coe Nothing))
              (coe MAlonzo.Code.Function.du58 (coe Just)
                 (coe d116 erased erased erased erased
                    MAlonzo.Code.Data.Product.d26))))
      (coe d340 erased erased v0)